...
- broader release: Store item、Developer ID署名、notarization、実機評価まで揃えて配布する

ライセンスはMIT Licenseを採用済みです。判断観点は [LICENSE_DECISION.md](./LICENSE_DECISION.md) にまとめています。
...
4. READMEのライセンス欄、告知文、[LICENSE_DECISION.md](./LICENSE_DECISION.md) の現在状態がMIT License採用と一致していることを確認する。

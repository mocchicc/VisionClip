...
現時点の配布はGitHubからの手動セットアップです。Chrome Web Storeへのupload workflowは用意していますが、Store公開はまだ行っていません。macOSアプリ化、署名・notarization、正式installer化も未対応です。一般配布へ向けて残っている作業は [docs/RELEASE_CHECKLIST.md](docs/RELEASE_CHECKLIST.md) にまとめています。

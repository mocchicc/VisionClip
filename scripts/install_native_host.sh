...
HOST_NAME="com.mocchicc.image_ocr"
INSTALL_DIR="$HOME/Library/Application Support/ImageOCRToClipboard"
...
{
  "name": "$HOST_NAME",
  "description": "Image OCR to Clipboard native messaging host",
  "path": "$HOST_BINARY",
  "type": "stdio",
  "allowed_origins": [
